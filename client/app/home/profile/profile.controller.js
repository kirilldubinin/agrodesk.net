(function() {
    'use strict';
    angular.module('agrodesk').controller('ProfileViewController', ProfileViewController);
    /** @ngInject */
    function ProfileViewController($scope, $state, $mdDialog, authFactory) {
        ...
        vm.changePassword = function(ev) {
            ...
            $mdDialog.show({
                ...
                templateUrl: './app/home/profile/changePassword/changePassword.html',
    ...
    angular.module('agrodesk').controller('ProfileEditController', ProfileEditController);
    /** @ngInject */
    ...
    angular.module('agrodesk').controller('AddUserController', AddUserController);
    /** @ngInject */
    ...
    angular.module('agrodesk').controller('ChangePasswordController', ChangePasswordController);
    /** @ngInject */
