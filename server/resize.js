...
var transporter = nodemailer.createTransport({
    ...
    secure: true, // use TLS
    auth: {
      user: "sales@prokorm.com",
      pass: "4noLimits$"
    }
  })//('smtps://sales%40prokorm.com:4noLimits$@smtp.gmail.com');
...
var mailOptionsEpam = {
    ...
    html: 
        `<!doctype html>
        <section>
            <table border="0" cellpadding="0" cellspacing="0" width="700px" style="font-family:Arial, Helvetica, sans-serif;border: 1px solid #f5f5f5;">
				<tr>
...
var mailOptionsVoerman = {
    ...
    <html>
        <table width="700px" style="font-family: Verdana, Geneva, Tahoma, sans-serif">
            <tr>
...
var mailOptionsSTART_MAY = {
    from: '<sales@prokorm.com>', // sender address 
    to: 'sales@prokorm.com', // list of receivers 
    subject: 'ПРОКОРМ: КОМБИКОРМ ДЛЯ ТЕЛЯТ, FEEDY START, (28.50 руб/кг)', // Subject line 
    html: `<meta charset="utf-8">
    <html>
    <table width="700px" height="100%" style="font-family: Verdana,'Helvetica Neue',Helvetica,sans-serif;background-color: #eaeaea; margin: 0 auto; padding: 10mm;">
      <tr>
        <td  style="background-color: #eaeaea">
          <table width="100%" height="100%" cellpadding="0" cellspacing="0" style="color:#4d626f">
            <tr>
              <td style="text-align:center; font-size: 22px;">
                <p style="text-align:center; font-weight: bold; font-size: 32px;margin:0px;">ООО "ПРОКОРМ"</p>
                кормление животных
                <br/><br/>
                8 800 550 28 27
                <br/><br/>
                Здравствуйте !
                <br/><br/>
                КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ НА КОМБИКОРМ
              <b>FEEDY START</b>  
              </td>
            </tr>
          </table>
          <br/><br/>
          <table width="700px" height="100%" cellpadding="0" cellspacing="0" style="margin: 0 auto; color:#4d626f">
            <tr>
              <td style="text-align:center; font-size: 16px; text-align: justify;line-height: 24px;">
                <p>ООО "ПРОКОРМ" предлагает <b>стартерный комбикорм для телят до 4 месяцев</b>. Белковая основа которого представлена в виде ПОДСОЛНЕЧНОГО ШРОТА, РАПСОВОГО ЖМЫХА И ЭКСТРУДИРОВАННОГО ГОРОХА, энергетическая состовляющая предствлена в виде КУКУРУЗЫ, ЯЧМЕНЯ, ПШЕНИЦЫ и НАТУРАЛЬНОГО ПОДСОЛНЕЧНОГО МАСЛА. Витаминно-минеральная часть базируется на премиксе для КРС "Camisan" (Германия).
                  Натуральный и сбаланасированный состав обеспечивает 100% поедаемость.
                  Цена комбикорма <b>FEEDY START - 28,50 руб за кг</b>. Упакован в крафт мешки по 25 кг.
                </p>
              </td>
            </tr>
          </table>
          ...
          <table width="700px" height="100%" cellpadding="0" cellspacing="0" style="margin: 0 auto; color:#4d626f">
            <tr>
              <td style="text-align:center; font-size: 18px; font-weight:bold; text-transform: uppercase;">
                Не содержит мочевины, отрубей, пивной дробины и других зерноотходов !
              </td>
            </tr>
          </table>
          ...
          <table width="700px" height="100%" cellpadding="0" cellspacing="0" style="margin: 0 auto; color:#4d626f">
            <tr>
              <td style="text-align:justify; font-size: 16px;">
                <b>Состав:</b> Подсолнечный шрот, ячмень, горох экструдированный, рапсовый жмых, кукуруза, пшеница, витаминно-минеральный премикс, масло растительное, известняковая мука, ароматизатор, подсластитель.
              </td>
            </tr>
          </table>
          ...
          <table width="700px" height="100%" cellpadding="0" cellspacing="0" style="margin: 0 auto; color:#4d626f">
            <tr>
              <td style="text-align:justify; font-size: 16px;">
                <b>Показатели:</b> СП (мин.) – 20,0%, ОЭ – 10,8 МДж, Сырая клетчатка (макс.) – 7,0%, Сырая зола (макс.) – 8,0%, Сырой жир (мин.) – 3,5%, Кальций (мин.) – 1,2%, Фосфор (мин.) – 0,6%, Массовая доля влаги (макс.) – 14,0%. Витамин А – 15 000,0 М.Е., Витамин D3 – 1 500,0 М.Е., Витамин Е – 120,0 мг.
              </td>
            </tr>
          </table>
          <br/>
          <table width="700px" height="100%" cellpadding="0" cellspacing="0" style="margin: 0 auto; color:#4d626f">
            <tr>
              <td style="text-align:justify;">
                <img width="100%" height="240px" style="object-fit:cover;" src="http://prokorm.com/START_MAY_2020-min.png"/>
              </td>
            </tr>
          </table>
...
// run each minute
// kirov, zelenina,mordov, kaluga, ryzan, vladimir, prokorm
var i = 0;
var emails = _.uniq(prokorm);

var inter =  setInterval(function () {
    if (emails[i]) {
        mailOptionsSTART_MAY.to = emails[i].trim();
        i++;
        console.log(mailOptionsSTART_MAY.to);
        console.log(mailOptionsSTART_MAY.subject);
        transporter.sendMail(mailOptionsSTART_MAY, function(error, info){
            if(error){
                console.log(error);
            } else if (info) {
                console.log(info);
